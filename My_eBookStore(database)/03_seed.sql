...
DELETE FROM store_activity_participation; DELETE FROM activity_books;
DELETE FROM point_rewards;         DELETE FROM order_items;
DELETE FROM payment_records;       DELETE FROM refund_records;
...
INSERT INTO store_admins (user_id, admin_name, admin_status) VALUES (SCOPE_IDENTITY(), N'张店主', N'正常');
GO

INSERT INTO users (user_name, password_hash, phone, email, user_type, status)
VALUES (N'seller_li', N'$2a$10$hashed_placeholder', N'13922222222', N'li@ebookstore.com', N'书店管理员', N'正常');
INSERT INTO store_admins (user_id, admin_name, admin_status) VALUES (SCOPE_IDENTITY(), N'李店主', N'正常');
GO

INSERT INTO users (user_name, password_hash, phone, email, user_type, status)
VALUES (N'seller_wang', N'$2a$10$hashed_placeholder', N'13933333333', N'wang@ebookstore.com', N'书店管理员', N'正常');
INSERT INTO store_admins (user_id, admin_name, admin_status) VALUES (SCOPE_IDENTITY(), N'王店主', N'正常');
GO
...
-- 把店铺1 中序号最小的那本 book_item 设为下架（测试边界条件）
